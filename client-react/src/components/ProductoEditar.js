...
class ProductoEditar extends React.Component {
    ...
    async componentDidMount() {
        ...
        const respuesta = await fetch(`${Constancia.RUTA_API}/${_id}`);
            ...
            <div className = "column">
                <div className = "col-md-6 offset-md-3">
                    <div className = "card card-body" style = {{width: "1300px"}}>
                        <h1 className = "is-size-3"> Editar producto </h1>
                        <br/>
                        <form className = "field" onSubmit = {this.manejarEnvioFormulario}>
                            ...
                            <div className = "form-group" style = {{margin: "auto", alignItems: "right", display: "flex"}}>
                                <button className = "button is-success mt-2"> Guardar cambios &nbsp; <FontAwesomeIcon icon = {faCheck} /> </button>
                            </div>
                        </form>
                    </div>
                </div>
